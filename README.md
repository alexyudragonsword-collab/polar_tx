...
| `ex11_benchmarks.py` | 文献级对标：Staszewski JSSC'05 EDGE polar（DEVM 2.0% vs 发表 ~2–3%）、Madoglio ISSCC'14 级 LTE-20（−31.1 vs ~−30 dB）、**Ben Bassat ISSCC/JSSC'20 Intel WiFi 6**（28nm SCPA，160 MHz 1024-QAM，裸 EVM −28.6 vs 发表 ~−29 dB @6dB BO，DPD 后 −38 属 −40 dB class）；802.11n 老对标保留为可导入历史锚点 |
